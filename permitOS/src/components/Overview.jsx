      ...
      <div className="rounded-xl border border-gray-700/40 bg-gray-900/40 overflow-hidden">
        ...
        {!showCompare && (
          <div className="px-5 py-3 flex items-center gap-6 text-xs">
            <span className="text-green-400 font-semibold">Brick: All 10 capabilities</span>
            <span className="text-amber-400">Scout: ~4 of 10</span>
            <span className="text-red-400">Traditional: 0 of 10 (speed/automation)</span>
          </div>
        )}
      </div>
